...
export class ProjectsComponent implements OnInit {
  ...
  projects = [
    {name: 'LocaIT', technologies: [ {t: 'HTML5 | ' }, {t: 'CSS3 | '}, {t: 'Bootstrap'} ] , description: 'For this project I worked with a collegue to make a rental car landing page website', demoLink: 'https://locait.netlify.com/', codeLink: 'https://github.com/AmineAML/LocaIT', displayImg: false, img: 'assets/videosBetterPerformance/project-videos/LocaITV.mp4'},
    {name: 'Cube Solves Timer', technologies: [ {t: 'C#' } ] , description: 'For this project I used C# to make an application that allows to users to keep track on their progress of solving the Rubik\'s Cube', demoLink: '', codeLink: '', displayImg: false, img: 'assets/videosBetterPerformance/project-videos/CubeTimeSolverV.mp4'},
    {name: 'NoteTaker', technologies: [ {t: 'C#' } ] , description: 'For this project I used C# to make an application for Windows 10 that resembles to the Windows 7 gadgets, which allow the users to take notes on their screen, it stores them and keeps them organized in a text file, with the feature of notifiying how many notes the app has stored', demoLink: '', codeLink: '', displayImg: false, img: 'assets/videosBetterPerformance/project-videos/NoteTakerV.mp4'},
